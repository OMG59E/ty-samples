...
class ILSVRC2012(BaseDataset):
    ...
    def __init__(self, root_path, batch_size=1):
        ...
        if not os.path.exists(root_path):
            print("ILSVRC2012 dataset path not exist -> {}".format(root_path))
            exit(-1)
        self._batch_idx = 0
        ...
        if not os.path.exists(self._val_file):
            print("Not found val file -> {}".format(self._val_file))
            exit(-1)
        if not os.path.exists(self._label_file):
            print("Not found val file -> {}".format(self._label_file))
            exit(-1)
